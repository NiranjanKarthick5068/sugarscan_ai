...
import { ArrowLeft, Watch } from 'lucide-react-native';
    ...
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.content}>
          <Watch size={48} color={COLORS.neon} style={{ marginBottom: 16 }} />
          <Text style={styles.title}>Connected Devices</Text>
          <Text style={styles.subtitle}>Pair your CGM, smartwatch, or smart scale.</Text>
        </View>
      </SafeAreaView>
    </View>
  );
