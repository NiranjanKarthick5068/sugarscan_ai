    ...
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Language & Units</Text>
          <View style={{ width: 24 }} />
        </View>

        <View style={styles.content}>
          <Globe size={48} color={COLORS.textSecondary} style={{ marginBottom: 16 }} />
          <Text style={styles.title}>Language & Units</Text>
          <Text style={styles.subtitle}>Configure language (English) and units (mg/dL, kg) here.</Text>
        </View>
      </SafeAreaView>
    </View>
  );
